          ...
          <Card className="border-none shadow-lg">
            <CardHeader className="text-center">
              <CardTitle className="font-montserrat font-semibold text-3xl text-primary-deep">
                Create Your YMGrad Account
              </CardTitle>
              <CardDescription className="text-lg mt-2">
                Join thousands of students on their path to international education success
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                  <div className="space-y-2">
                    ...
                    <div className="h-1 w-full bg-gray-200 mt-2">
                      <div className="h-1 w-1/4 bg-red-500"></div>
                    </div>
                    <p className="text-xs text-gray-500">Password strength: Weak</p>
                  </div>
                  <div className="space-y-2">
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-start space-x-2">
                    ...
                    <div className="grid gap-1.5 leading-none">
                      ...
                      >
                        I agree to receive educational resources and updates from YMGrad
                      </label>
                    </div>
                  </div>
